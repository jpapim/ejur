...
namespace UnidadeTempo\Controller;
...
class UnidadeTempoController extends AbstractCrudController
{
    /**
    ...
    public function indexPaginationAction()
    {
        ...
        $camposFilter = [
            '0' => [
                'filter' => "unidade_tempo.nm_unidade_tempo LIKE ?",
            ],            
        ...
        $paginator = $this->service->getUnidadeTempoPaginator($filter, $camposFilter);
...
public function gravarAction(){
    ...
    public function obterUnidadeTempoAction()
    {
        
        $params = $this->getRequest()->getPost()->toArray();
        
        $form = new \UnidadeTempo\Form\UnidadeTempoForm(['params' => $params]);
