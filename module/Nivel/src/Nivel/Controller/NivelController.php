...
class NivelController extends AbstractCrudController
{
    /**
    ...
    public function indexPaginationAction()
    {
        ...
        $paginator = $this->service->getNivelPaginator($filter, $camposFilter);
...
public function gravarAction(){
    ...
    public function obterNivelAction()
    {
        
        $params = $this->getRequest()->getPost()->toArray();
        
        $form = new \Nivel\Form\NivelForm(['params' => $params]);
